...
public class FiveThirtyEightReaderTest2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(fte.sameTeam(testGame.getAwayTeam(), trueGame[4]));
		System.out.println(fte.sameTeam(testGame.getHomeTeam(), trueGame[5]));
		System.out.println(fte.sameTeam(testGame.getAwayTeam(), falseGame[4]));
		System.out.println(fte.sameTeam(testGame.getHomeTeam(), falseGame[5]));
